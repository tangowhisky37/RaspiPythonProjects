...
#message = "Intemp - " + roomtemp + " DegC, Outtemp - " + outsidetemp + " DegC, InHumidity - " + roomhumidity + " %, OutHumidity - " + outsidehumidity + " %, airspeed - " + outairspeed + " Kts, Cloud cover - " + outcloudcover + " x000 ft." 

message = "Intemp " + roomtemp + " C, Outtemp " + outsidetemp + " C, InHumidity " + roomhumidity + " %, OutHumidity " + outsidehumidity + " %, airspeed " + outairspeed + " Kts, Cloud " + outcloudcover + " x000 ft." 
print message
